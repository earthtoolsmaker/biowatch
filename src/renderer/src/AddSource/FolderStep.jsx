...
/**
 * Step 2 of the Add Source wizard — folder import flow.
 *
 * Behavior preserved from the pre-wizard AddSourceModal:
 ...
 */
export default function FolderStep({ isOpen, studyId, onBack, onClose, onImported }) {
      ...
      >
        <header className="flex items-center justify-between px-5 py-4 border-b border-border">
          <h3 className="text-base font-medium text-foreground">
            Add source <span className="text-muted-foreground text-sm">— Images directory</span>
          </h3>
          <button
            onClick={onClose}
            disabled={submitting}
        ...
        <footer className="flex justify-between items-center gap-2 px-5 py-3 border-t border-gray-200 dark:border-border bg-gray-50 dark:bg-muted">
