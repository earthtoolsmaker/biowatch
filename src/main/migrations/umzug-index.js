...
/**
 * Register a new migration (for backward compatibility)
 * @param {string} _version - Version identifier (unused)
 * @param {Object} _migration - Migration object (unused)
 */
export function registerMigration(_version, _migration) {
  // This is kept for backward compatibility but migrations should be registered
  // directly in the createUmzug function above
  console.warn('registerMigration is deprecated. Register migrations directly in createUmzug.')
}
